...
insert into staff values('111','tom','man','22',9 ,'123','技术部');
...
insert into offer values('东风','十堰','A','15926170536','tom');
...
insert into part values('001','车轮','A','258','东风',10);
...
delete from offer where o_name = '东风'
...
insert into testchart values('三星',3000);
insert into testchart values('华为',3500);
insert into testchart values('小米',2000);
insert into testchart values('魅族',1500);
insert into testchart values('苹果',6000);
