<%-- 
    Document   : changereader
    Created on : 2017-6-20, 12:04:53
    Author     : pichaojun
--%>
            ...
            <div class="line">
                ...
                <div class="xl12 xs9 xm9 xb9 padding-small-top">
                    <div class="margin-big-left padding-big">
                        <form method="post" action="changereaderinfoDao">
                            <div class="form-group">
                                <div class="label">
                                    <label for="readerid">读者编号</label>
                                </div>
                                <div class="field">
                                    <input type="text" value="${reader.readerid}" readonly class="input" id="readerid" name="readerid" size="50" placeholder="读者编号" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="field">
                                    <input type="text" value="${reader.readername}" class="input" id="readername" name="readername" size="50" placeholder="读者姓名" data-validate="required:必填"/>
                                </div>
                            </div>
                                
                             <div class="form-group">
                                <div class="label">
                                    <label for="readersex">读者性别</label>
                                </div>
                             <div class="field">
                                    <div class="button-group radio">
                                        <c:if test="${reader.readersex =='男'}">
                                        ...
                                        <c:if test="${reader.readersex =='女'}">
                                            <label class="button">
                                                <input name="readersex" value="男" type="radio"><span class="icon icon-male"></span> 男
                                            </label>
                                            <label class="button active">
                                                <input name="readersex" value="女" checked="checked" type="radio"><span class="icon icon-female"></span> 女
                                            </label>
                                        </c:if>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="field">
                                    <input type="text" value="${reader.readerage}" class="input" id="readerage" name="readerage" size="50" placeholder="读者年龄" data-validate="required:必填,plusinteger:必须是数字,compare#>15:年龄必须大于15岁"/>
                                </div>
                            </div> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="field">
                                    <input type="text" value="${reader.readerclass}" class="input" id="readerclass" name="readerclass" size="50" placeholder="读者姓名" data-validate="required:必填"/>
                                </div>
                            </div>
                           ...
                           <div class="form-group">
                                ...
                                <div class="field">
                                    <div class="button-group radio">
                                        <c:if test="${reader.readerpermitted =='可以借书'}">
                                            <label class="button active">
                                        ...
                                        <c:if test="${reader.readerpermitted =='不可借书'}">
                                            <label class="button">
                                                <input name="readerpermitted" value="可以借书" type="radio"><span class="icon icon-check-circle"></span> 可以借书
                                            </label>
                                            <label class="button active">
                                                <input name="readerpermitted" value="不可借书" checked="checked" type="radio"><span class="icon icon-times-circle"></span> 不可借书
                                            </label>
                                        </c:if>
                                    </div>
                                </div>
