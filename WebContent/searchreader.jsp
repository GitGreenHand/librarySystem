<%-- 
    Document   : searchreader
    Created on : 2017-6-19, 22:10:58
    Author     : pichaojun
--%>
                    ...
                    <table class="table table-striped">     
                            ...
                            <c:forEach var="reader" items="${readers}">
                                <tr>
                                    ...
                                    <td>
                                        <a href="#?bookno=${reader.readerid}" class="button button-small border-red" onclick="return ConfDel();"><span class="icon-trash-o"></span> 删除</a>|
                                        <a href="#?bookno=${reader.readerid}" class="button button-small border-main"><span class="icon-edit"></span>修改</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </table>
