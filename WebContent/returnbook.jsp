                    ...
                    <div class="margin-big-left padding-big">
                        <form method="post" action="returnbook">
                            <div class="form-group">
                                <div class="label">
                                    <label for="bookno">请输入归还的图书编号</label>
                                </div>
                                <div class="field">
                                    <input type="text" class="input" id="bookno" name="bookno" size="50" placeholder="图书编号" data-validate="required:必填,length#==8:id长度为8"/>
                                </div>
                            </div>                                     
                                                      
                            <div class="form-button">
                                <button class="button" type="submit">归还</button>
                            </div>
