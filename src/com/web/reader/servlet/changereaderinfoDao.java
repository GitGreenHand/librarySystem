 ...
 * @author pichaojun
 */
@WebServlet(name = "changereaderinfoDao",urlPatterns = {"/changereaderinfoDao"})
public class changereaderinfoDao extends  HttpServlet{
    @Override
    protected void doPost (HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       reader.setReaderpermitted(readerpermitted);
        ...
        ReaderDaoFactory.getReaderDao().updateReaderinfo(reader);
       
       
        
        //BookDaoFactory.getBookDao().updateBookinfo(book);
